...
function injectTrackingPixel(html: string, campaignId: string, subscriberId: string, businessId: string): string {
...
function wrapLinksForTracking(html: string, campaignId: string): string {
