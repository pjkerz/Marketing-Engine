...
function findClientScore(keyword: string, clientKws: KeywordScore[]): number {
...
export function analyseGap(
  clientKws: KeywordScore[],
  competitorKws: KeywordScore[],
): GapKeyword[] {
  ...
  for (const compKw of competitorKws) {
    ...
    const priority: GapKeyword['priority'] =
